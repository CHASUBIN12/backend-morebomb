...
CORS(app, resources={r"/chat": {"origins": ["http://localhost:5000", "http://localhost:3000", "http://localhost:5173","https://frontend-morebomb-lifyppdxm-chasubins-projects.vercel.app","https://frontend-morebomb.vercel.app"]}})
